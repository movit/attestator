...
public final class ApplicationCache extends JavaScriptObject {
  ...
  public native void addEventListener(String type, EventListener listener,
    ...
    this.addEventListener(
      type,
      function(event) {
        @com.attestator.player.client.helper.ApplicationCache::handleCacheEvents(Lcom/google/gwt/user/client/EventListener;Lcom/google/gwt/user/client/Event;) (listener, event);
      },
      useCapture
    );
  }-*/;
